...
The `config.mjs` file is shared by Task hub and Processors (loaded into their local config.mjs). This should actually load the variables from a JSON file. It provides:
* appLabel
* appName
* appAbbrev
* REDIS_URL
