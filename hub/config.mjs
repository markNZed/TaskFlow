...
const CONFIG_DIR = process.env.CONFIG_DIR || "./../nodejsProcessor/config-v02/";

console.log("TASKHUB_URL", TASKHUB_URL)

export { BROWSER_URL, DEFAULT_USER, CACHE_ENABLE, MAP_USER, appLabel, appName, appAbbrev, CONFIG_DIR };
