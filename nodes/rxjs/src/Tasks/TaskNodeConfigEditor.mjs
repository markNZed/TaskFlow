...
/*
ServiceNodeConfig provides read/write access to configuration data, TaskNodeConfigs registers callbacks with ServiceNodeConfig and maintains shared.system.XXXConfigTree which is synchronised by TaskCEPShared and used by TaskSystemMenu, TaskNodeConfigEditor and TaskChat (when configured with this).
*/
