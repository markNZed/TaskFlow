...
* The `/app/shared` directory is soft linked from `/app/nodes/hub/src/shared`, `/app/processor/nodejs/src/shared`, `/app/nodes/react/src/shared`, `/app/nodes/rxjs/src/shared`. In that directory we have the JSON schema for the Task object, `utils.mjs`, and XState finite state machine definitions in `/app/shared/fsm`.
