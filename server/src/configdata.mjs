                  ...
                  && !workflowkey.startsWith("PREPEND_"))
              {
                ...
                if (workflow.tasks[taskkey].hasOwnProperty('PREPEND_' + workflowkey)) {
                  if (Array.isArray(workflow.tasks[taskkey]['PREPEND_' + workflowkey])) {
                    workflow.tasks[taskkey][workflowkey] = workflow.tasks[taskkey]['PREPEND_' + workflowkey].concat(workflow[workflowkey]);
                  } else {
                    workflow.tasks[taskkey][workflowkey] = workflow.tasks[taskkey]['PREPEND_' + workflowkey] + workflow[workflowkey]
                  }
                  ...
                  if (Array.isArray(workflow.tasks[taskkey]['APPEND_' + workflowkey])) {
                    workflow.tasks[taskkey][workflowkey] = workflow[workflowkey].concat(workflow.tasks[taskkey]['APPEND_' + workflowkey]);
                  } else {
                    workflow.tasks[taskkey][workflowkey] =  workflow[workflowkey] + workflow.tasks[taskkey]['APPEND_' + workflowkey]
                  }
                }
