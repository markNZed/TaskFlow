...
screen -S my-session -p 0 -X stuff "cd /app/taskflow/hub\n"
...
screen -S my-session -p 1 -X stuff "cd /app/taskflow/processor/nodejs\n"
...
screen -S my-session -p 3 -X stuff "cd /app/taskflow/processor/react\n"
